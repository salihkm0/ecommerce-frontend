...
export const CheckoutPage = () => {
  ...
  const handleCheckout = async (data) => {
    console.log(data);
    try {
      const res = await axios.post("http://localhost:5555/api/v1/checkout",data, {
        withCredentials: true,
      });
      console.log(res);
      if(res.data.success){
        toast.success("Order Placed Successfully")
        return navigate('/order-summery')
      }
      else {
  ...
  return (
    <>
      <StyledContainer className="dark:bg-gray-900 ">
                    ...
                    <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 ps-4 dark:border-gray-700 dark:bg-gray-800">
                      <div className="flex items-start">
                        <div className="flex h-5 items-center">
                          <input
                            id="razorpay-2"
                            aria-describedby="razorpay-text"
                            type="radio"
                            name="payment-method"
                            className="h-4 w-4 border-gray-300 bg-white text-primary-600 focus:ring-2 focus:ring-primary-600 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"
                            value={"razorpay"}
                        ...
                        <div className="ms-4 text-sm">
                          ...
                          <p
                            ...
                            className="mt-1 text-xs font-normal text-gray-500 dark:text-gray-400"
                          >
                            All Payment solution are available
                          </p>
                        </div>
                      </div>
                    </div>
